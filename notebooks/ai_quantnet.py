...
# If you use braindecode helpers:
...
class QuantDeep4NetFINN(BaseModel):
    """
    FINN-friendly Deep4Net:
    ...
    def create_network(self):
        ...
        # DO NOT add softmax/squeeze/transpose here — do it on host after FPGA inference
        ...
        model.eval()  # export/inference path
        return model

# ---------- small helpers ----------

def _transpose_time_to_spat(x: torch.Tensor) -> torch.Tensor:
    # (N, C, T, 1) -> (N, 1, T, C)  (NCHW kept; convs use (k_t, 1))
